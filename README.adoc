...
The following is a table of Android ORM technologies (to be) tried:
...
to a tech-specific ++SaveActivity++ to save the Person.
Because of difficulties using a single Person class, Person became an Interface.
The implementation name of the +SaveActivity+ as well as any domain-specific Domain implementatiions
